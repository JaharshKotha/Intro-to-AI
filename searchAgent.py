...
#         """
#         "*** YOUR CODE HERE ***"
#         return (self.startingPosition , self.corner_check)
#
#     def isGoalState(self, state):
#         """
#         Returns whether this search state is a goal state of the problem.
...
#             nextx, nexty = int(x + dx), int(y + dy)
#             if not self.walls[nextx][nexty]:
#                 for cval in self.corners:
#                     if cval == (nextx,nexty):
#                         g = self.corners.index((nextx,nexty))
#                         if g == 0:
#                             dict = dict[:0] + "T" + dict[0 + 1:]
#                             break
#                         if g == 1:
#                             dict = dict[:1] + "T" + dict[1 + 1:]
#                             break
#                         if g == 2:
#                             dict = dict[:2] + "T" + dict[2 + 1:]
#                             break
#                         if g == 3:
#                             dict = dict[:3] + "T" + dict[3 + 1:]
#                             break
#
#                 npos = (nextx, nexty)
#                 nextState = (npos ,dict)
...
def cornersHeuristic(state, problem):
    ...
    #     cnt1 = cnt1 + 1
    #     if cnt1 in res:
    #         tcorner= corners[cnt1]
    #         d = util.manhattanDistance(pos, tcorner)
    #         if d < lengths:
    #             lengths = d
    #
        ...
        #     for j in corners:
        #         if cnt != cnt1:
        #             d = util.manhattanDistance(pos, j)
        #             res.append(d)
        # cnt=cnt+1
   # print res
